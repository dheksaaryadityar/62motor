    ...
    <?php foreach ($type as $tp) : ?>
        <form method="POST" action="<?php echo base_url('admin/data_type/update_type_aksi') ?>">
            ...
            <div class="form-group">
                ...
                <input type="text" name="kode_type" class="form-control" id="" value="<?php echo $tp->kode_type ?>">
                <?php echo form_error('kode_type', '<div class="text-small text-danger">', '</div>') ?>
            </div>
            <div class="form-group">
                <label for="">Nama Type</label>
                <input type="text" name="nama_type" class="form-control" id="" value="<?php echo $tp->nama_type ?>">
