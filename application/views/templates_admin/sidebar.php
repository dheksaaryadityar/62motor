            ...
            <div class="main-sidebar">
                <aside id="sidebar-wrapper">
                    <div class="sidebar-brand">
                        <a href="index.html">DEALER MOTOR</a>
                    </div>
                    <div class="sidebar-brand sidebar-brand-sm">
                        <a href="index.html">DLM</a>
                    </div>
                    <ul class="sidebar-menu">

                        <li><a class="nav-link" href="<?php echo base_url('admin/dashboard') ?>"><i class="fas fa-tachometer-alt"></i> <span>Dashboard</span></a></li>
                        <li><a class="nav-link" href="<?php echo base_url('admin/data_motor') ?>"><i class="fa-solid fa-motorcycle"></i> <span>Data Motor</span></a></li>
